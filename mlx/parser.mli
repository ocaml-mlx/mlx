...
type token = 
  ...
  | LAZY
  | LABEL of (string)
  | JSX_UIDENT_E of (string)
  | JSX_UIDENT of (string)
  | JSX_LIDENT_E of (string)
  | JSX_LIDENT of (string)
...
val parse_val_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)

val parse_pattern: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Parsetree.pattern)

val parse_mty_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)
...
val parse_mod_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)

val parse_mod_ext_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)
...
val parse_constr_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)

val parse_any_longident: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Mlx_shim.Longident.t)
...
module Incremental : sig
  ...
  val parse_val_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
  
  val parse_pattern: Lexing.position -> (Parsetree.pattern) MenhirInterpreter.checkpoint
  
  val parse_mty_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
  ...
  val parse_mod_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
  
  val parse_mod_ext_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
  ...
  val parse_constr_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
  
  val parse_any_longident: Lexing.position -> (Mlx_shim.Longident.t) MenhirInterpreter.checkpoint
