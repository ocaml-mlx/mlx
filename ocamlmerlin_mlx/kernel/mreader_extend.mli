# 1 "merlin/src/kernel/mreader_extend.mli"
type t
...
val print_pretty : Extend_protocol.Reader.pretty_parsetree -> t -> string option

val print_outcomes :
  Extend_protocol.Reader.outcometree list -> t -> string list option

val print_outcome : Extend_protocol.Reader.outcometree -> t -> string option
