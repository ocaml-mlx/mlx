...
module MenhirInterpreter : sig
  ...
  type _ terminal = 
    ...
    | T_JSX_UIDENT_E : (string) terminal
    | T_JSX_UIDENT : (string) terminal
    | T_JSX_LIDENT_E : (string) terminal
    | T_JSX_LIDENT : (string) terminal
  ...
  Parsetree.attributes) nonterminal
    ...
    | N_simple_param_pattern : (Asttypes.arg_label * Parsetree.expression option * Parsetree.pattern) nonterminal
  ...
  Parsetree.type_declaration) nonterminal
    | N_generic_constructor_declaration_epsilon_ : (Mlx_ocaml_parsing.Ast_helper.str * Mlx_ocaml_parsing.Ast_helper.str list *
  Parsetree.constructor_arguments * Parsetree.core_type option *
  Parsetree.attributes * Warnings.loc * Mlx_ocaml_parsing.Docstrings.info) nonterminal
    | N_generic_constructor_declaration_BAR_ : (Mlx_ocaml_parsing.Ast_helper.str * Mlx_ocaml_parsing.Ast_helper.str list *
  Parsetree.constructor_arguments * Parsetree.core_type option *
  Parsetree.attributes * Warnings.loc * Mlx_ocaml_parsing.Docstrings.info) nonterminal
    | N_generalized_constructor_arguments : (Mlx_ocaml_parsing.Ast_helper.str list * Parsetree.constructor_arguments *
  Parsetree.core_type option) nonterminal
    ...
    | N_expr_colon_package_type : (Parsetree.expression) nonterminal
